...
execute if predicate hss:is_imbel_gc if entity @s[scores={usedGun=1..}] run playsound hss:fire.gc_9mm player @a ~ ~ ~
execute if predicate hss:is_imbel_gc if entity @s[scores={is9mmEmpty=1}] run playsound hss:dry_fire.gc_9mm player @a ~ ~ ~
