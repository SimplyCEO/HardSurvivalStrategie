...
execute at @s positioned ~ ~1.4 ~ positioned ^ ^ ^.8 run summon armor_stand ^ ^ ^ {Small:1b,Invulnerable:1b,Invisible:1b,NoBasePlate:1b,Tags:["gaugeBullet","rotated","1"]}
execute at @s positioned ~ ~1.4 ~ positioned ^ ^ ^.8 run summon armor_stand ^ ^ ^ {Small:1b,Invulnerable:1b,Invisible:1b,NoBasePlate:1b,Tags:["gaugeBullet","rotated","2"]}
execute at @s positioned ~ ~1.4 ~ positioned ^ ^ ^.8 run summon armor_stand ^ ^ ^ {Small:1b,Invulnerable:1b,Invisible:1b,NoBasePlate:1b,Tags:["gaugeBullet","rotated","3"]}
execute at @s positioned ~ ~1.4 ~ positioned ^ ^ ^.8 run summon armor_stand ^ ^ ^ {Small:1b,Invulnerable:1b,Invisible:1b,NoBasePlate:1b,Tags:["gaugeBullet","rotated","4"]}
execute at @s positioned ~ ~1.4 ~ positioned ^ ^ ^.8 run summon armor_stand ^ ^ ^ {Small:1b,Invulnerable:1b,Invisible:1b,NoBasePlate:1b,Tags:["gaugeBullet","rotated","5"]}
