replaceitem block ~ ~ ~ container.15 armor_stand{advancedWorkbench:1b,display:{Name:'{"translate":"item.hss.combiner","color":"gold","italic":false}'},CustomModelData:4,EntityTag:{Silent:1b,Tags:["combiner"],Invulnerable:1b,Invisible:1b,Fixed:1b}}
