...
execute at @s[tag=gaugeBullet,distance=..10,tag=1] if entity @e[type=!item_frame,type=!area_effect_cloud,distance=0..1.5,sort=nearest,limit=1] run function hss:modules/rubbish_weapons/give_effect/m1014
execute at @s[tag=gaugeBullet,distance=..10,tag=2] if entity @e[type=!item_frame,type=!area_effect_cloud,distance=0..1.5,sort=nearest,limit=1] run function hss:modules/rubbish_weapons/give_effect/m1014
execute at @s[tag=gaugeBullet,distance=..10,tag=4] if entity @e[type=!item_frame,type=!area_effect_cloud,distance=0..1.5,sort=nearest,limit=1] run function hss:modules/rubbish_weapons/give_effect/m1014
execute at @s[tag=gaugeBullet,distance=..10,tag=5] if entity @e[type=!item_frame,type=!area_effect_cloud,distance=0..1.5,sort=nearest,limit=1] run function hss:modules/rubbish_weapons/give_effect/m1014
execute at @s[tag=gaugeBullet,distance=..10,tag=5] if entity @e[type=!item_frame,type=!area_effect_cloud,distance=0..1.5,sort=nearest,limit=1] run function hss:modules/rubbish_weapons/give_effect/m1014
...
execute at @s[tag=gaugeBullet,distance=..10,tag=1] if block ^ ^ ^.1 #hss:bullet_ricochet_transparent run playsound hss:bullet.ricochet player @a ~ ~ ~
execute at @s[tag=gaugeBullet,distance=..10,tag=2] if block ^ ^ ^.1 #hss:bullet_ricochet_transparent run playsound hss:bullet.ricochet player @a ~ ~ ~
...
execute at @s[tag=gaugeBullet,distance=..50,tag=1] run particle dust 0.0 0.0 0.0 1.0
execute at @s[tag=gaugeBullet,distance=..50,tag=2] run particle dust 0.0 0.0 0.0 1.0
execute at @s[tag=gaugeBullet,distance=..50,tag=4] run particle dust 0.0 0.0 0.0 1.0
execute at @s[tag=gaugeBullet,distance=..50,tag=5] run particle dust 0.0 0.0 0.0 1.0
execute at @s[tag=gaugeBullet,distance=..50,tag=3] run particle dust 0.0 0.0 0.0 1.0

kill @s[tag=gaugeBullet,distance=..50,tag=1]
kill @s[tag=gaugeBullet,distance=..50,tag=2]
kill @s[tag=gaugeBullet,distance=..50,tag=4]
kill @s[tag=gaugeBullet,distance=..50,tag=5]
kill @s[tag=gaugeBullet,distance=..50,tag=3]