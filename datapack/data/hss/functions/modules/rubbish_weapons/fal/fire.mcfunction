...
execute at @s if entity @e[type=!item,type=!armor_stand,type=!item_frame,type=!area_effect_cloud,distance=0..1.5,sort=nearest,limit=1] run function hss:modules/rubbish_weapons/give_effect/fal
