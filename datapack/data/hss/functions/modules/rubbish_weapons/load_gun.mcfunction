...
execute if predicate hss:is_fal if entity @s[tag=natoBroken] run item replace entity @s hotbar.0 with air
...
execute if predicate hss:is_m1014 if entity @s[tag=gaugeBroken] run item replace entity @s hotbar.0 with air
...
execute if predicate hss:is_gc_9mm if entity @s[tag=9mmBroken] run item replace entity @s hotbar.0 with air
...
execute if predicate hss:is_aglc if entity @s[tag=sniperBroken] run item replace entity @s hotbar.0 with air
...
execute if predicate hss:is_igla if entity @s[tag=iglaBroken] run item replace entity @s hotbar.0 with air
