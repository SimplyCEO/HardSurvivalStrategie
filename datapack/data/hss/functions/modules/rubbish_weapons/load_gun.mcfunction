...
execute as @e[type=minecraft:player,scores={debug=1}] run tellraw @s "[§b§lMODULE§f] Module§9 hss:modules/rubbish_weapons/load_gun §floaded."
...
execute if predicate hss:is_fal as @s[tag=natoBroken] run item replace entity @s hotbar.0 with minecraft:air
...
execute if predicate hss:is_m1014 as @s[tag=gaugeBroken] run item replace entity @s hotbar.0 with minecraft:air
...
execute if predicate hss:is_gc_9mm as @s[tag=9mmBroken] run item replace entity @s hotbar.0 with minecraft:air
...
execute if predicate hss:is_aglc as @s[tag=sniperBroken] run item replace entity @s hotbar.0 with minecraft:air
...
execute if predicate hss:is_igla as @s[tag=iglaBroken] run item replace entity @s hotbar.0 with minecraft:air
