...
execute as @e[type=player,scores={debug=1,verbose=1}] run tellraw @s "[§b§lMODULE§f] Module§9 hss:modules/set_scores §floaded."
...
execute if score @s usedW_Hoe matches 1.. run scoreboard players set @s usedW_Hoe 0
