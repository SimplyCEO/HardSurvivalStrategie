...
item replace block ~ ~ ~ container.16 with honeycomb_block{concentratedHoneycomb:1b,Enchantments:[{id:1,lvl:1}],display:{Name:'{"translate":"item.hss.concentrated_honeycomb","color":"green","italic":false}'}}
item replace block ~ ~ ~ container.24 with honeycomb_block{concentratedHoneycomb:1b,Enchantments:[{id:1,lvl:1}],display:{Name:'{"translate":"item.hss.concentrated_honeycomb","color":"green","italic":false}'}}
