...
# TAG: steelPickaxe
# PLACEHOLDER: minecraft:iron_pickaxe (1)
# RECIPE:
#
# |---|---|---|
# | X | X | X |
...
execute unless score @s slot9 matches 1.. run item replace block ~ ~ ~ container.15 with iron_pickaxe{steelPickaxe:1b,CustomModelData:1,display:{Name:'{"translate":"item.hss.steel_pickaxe","italic":false}'}}
