...
item replace block ~ ~ ~ container.15 with minecraft:iron_pickaxe{steelPickaxe:1b,CustomModelData:1,display:{Name:'{"translate":"item.hss.steel_pickaxe","italic":false}'}}
