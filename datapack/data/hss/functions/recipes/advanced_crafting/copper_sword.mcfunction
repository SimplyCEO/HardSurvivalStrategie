...
execute unless score @s slot9 matches 1.. run item replace block ~ ~ ~ container.15 with stone_sword{copperSword:1b,CustomModelData:1,display:{Name:'{"translate":"item.hss.copper_sword","italic":false}'}}
