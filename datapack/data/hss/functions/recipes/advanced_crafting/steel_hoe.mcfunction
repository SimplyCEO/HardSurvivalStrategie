execute unless score @s slot9 matches 1.. run item replace block ~ ~ ~ container.15 with iron_hoe{steelHoe:1b,CustomModelData:1,display:{Name:'{"translate":"item.hss.steel_hoe","italic":false}'}}
