...
# TAG: rubyHoe
# PLACEHOLDER: minecraft:netherite_hoe (1)
# RECIPE:
#
# |---|---|---|
# | X | X |   |
...
execute unless score @s slot9 matches 1.. run item replace block ~ ~ ~ container.15 with netherite_hoe{rubyHoe:1b,CustomModelData:1,display:{Name:'{"translate":"item.hss.ruby_hoe","italic":false}'}}
