...
execute if score @s thirstCount matches ..9 if score tickCount count matches 0 run title @s actionbar [{"text":"🧪 ","color":"aqua"},{"text":"0","color":"aqua"},{"score":{"name":"@s","objective":"thirstCount"},"color":"aqua"},{"text":"/20   ","color":"aqua"},{"text":"☀   ","color":"dark_blue"},{"text":"☠ ","color":"yellow"},{"score":{"name":"@s","objective":"biohazardCount"},"color":"yellow"},{"text":"    "}]
execute if score @s thirstCount matches ..9 if score tickCount count matches 2 run title @s actionbar [{"text":"🧪 ","color":"aqua"},{"text":"0","color":"aqua"},{"score":{"name":"@s","objective":"thirstCount"},"color":"aqua"},{"text":"/20   ","color":"aqua"},{"text":"☀   ","color":"dark_blue"},{"text":"☠ ","color":"yellow"},{"score":{"name":"@s","objective":"biohazardCount"},"color":"yellow"},{"text":"    "}]
