...
execute as @s[scores={gaugeBullets=990..}] run function hss:rubbish_guns/m1014/break_gun
...
execute as @e[tag=gaugeBullet,tag=rotated] at @s rotated as @p run function hss:rubbish_guns/m1014/fire
