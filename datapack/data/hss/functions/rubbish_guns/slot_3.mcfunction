...
execute if predicate hss:is_para_fal if entity @s[tag=natoLoaded,scores={isRunning=1..}] run replaceitem entity @s hotbar.3 carrot_on_a_stick{rubbishGuns:1b,paraFAL:1b,CustomModelData:1,display:{Name:'{"text":"","italic":false}',Lore:['{"translate":"item.hss.para_fal","color":"white","italic":false}']}}
execute if predicate hss:is_para_fal if block ~ ~-.1 ~ air run replaceitem entity @s hotbar.3 carrot_on_a_stick{rubbishGuns:1b,paraFAL:1b,CustomModelData:1,display:{Name:'{"text":"","italic":false}',Lore:['{"translate":"item.hss.para_fal","color":"white","italic":false}']}}
...
execute if predicate hss:is_benelli_m4 if entity @s[tag=gaugeLoaded,scores={isRunning=1..}] run replaceitem entity @s hotbar.3 carrot_on_a_stick{rubbishGuns:1b,benelliM4:1b,CustomModelData:2,display:{Name:'{"text":"","italic":false}',Lore:['{"translate":"item.hss.benelli_m4","color":"white","italic":false}']}}
execute if predicate hss:is_benelli_m4 if block ~ ~-.1 ~ air run replaceitem entity @s hotbar.3 carrot_on_a_stick{rubbishGuns:1b,benelliM4:1b,CustomModelData:2,display:{Name:'{"text":"","italic":false}',Lore:['{"translate":"item.hss.benelli_m4","color":"white","italic":false}']}}
...
execute if predicate hss:is_imbel_gc if entity @s[tag=9mmLoaded,scores={isRunning=1..}] run replaceitem entity @s hotbar.3 carrot_on_a_stick{rubbishGuns:1b,imbelGC:1b,CustomModelData:3,display:{Name:'{"text":"","italic":false}',Lore:['{"translate":"item.hss.imbel_gc","color":"white","italic":false}']}}
execute if predicate hss:is_imbel_gc if block ~ ~-.1 ~ air run replaceitem entity @s hotbar.3 carrot_on_a_stick{rubbishGuns:1b,imbelGC:1b,CustomModelData:3,display:{Name:'{"text":"","italic":false}',Lore:['{"translate":"item.hss.imbel_gc","color":"white","italic":false}']}}
...
execute if predicate hss:is_imbel_aglc if entity @s[tag=sniperLoaded,scores={isRunning=1..}] run replaceitem entity @s hotbar.3 carrot_on_a_stick{rubbishGuns:1b,imbelAGLC:1b,CustomModelData:4,display:{Name:'{"text":"","italic":false}',Lore:['{"translate":"item.hss.imbel_aglc","color":"white","italic":false}']}}
execute if predicate hss:is_imbel_aglc if block ~ ~-.1 ~ air run replaceitem entity @s hotbar.3 carrot_on_a_stick{rubbishGuns:1b,imbelAGLC:1b,CustomModelData:4,display:{Name:'{"text":"","italic":false}',Lore:['{"translate":"item.hss.imbel_aglc","color":"white","italic":false}']}}
...
execute if predicate hss:is_igla if entity @s[tag=iglaLoaded,scores={isRunning=1..}] run replaceitem entity @s hotbar.3 carrot_on_a_stick{rubbishGuns:1b,igla:1b,CustomModelData:5,display:{Name:'{"text":"","italic":false}',Lore:['{"translate":"item.hss.igla","color":"white","italic":false}']}}
execute if predicate hss:is_igla if block ~ ~-.1 ~ air run replaceitem entity @s hotbar.3 carrot_on_a_stick{rubbishGuns:1b,igla:1b,CustomModelData:5,display:{Name:'{"text":"","italic":false}',Lore:['{"translate":"item.hss.igla","color":"white","italic":false}']}}
