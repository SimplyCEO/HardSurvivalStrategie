...
execute at @s[tag=gaugeBullet,distance=..10,tag=4] if entity @e[type=!item_frame,type=!area_effect_cloud,distance=0..1.5,sort=nearest,limit=1] run function hss:rubbish_guns/give_effect/m1014
