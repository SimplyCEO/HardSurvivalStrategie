...
execute if entity @s[nbt={Dimension:"minecraft:the_nether"}] run scoreboard players add @s biohazardCount 1
execute if entity @s[nbt={Dimension:"minecraft:the_end"}] run scoreboard players add @s biohazardCount 1