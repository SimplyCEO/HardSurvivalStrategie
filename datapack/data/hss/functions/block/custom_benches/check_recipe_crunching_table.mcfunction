...
execute if score @s[nbt={Item:{id:"minecraft:quartz"}}] count matches 2.. if score @e[type=item,distance=...3,nbt={Item:{id:"minecraft:cobblestone"}},sort=nearest,limit=1] count matches 2.. run function hss:recipes/crunching_table/diorite
execute if score @s[nbt={Item:{id:"minecraft:clay_ball"}}] count matches 2.. if score @e[type=item,distance=...3,nbt={Item:{id:"minecraft:cobblestone"}},sort=nearest,limit=1] count matches 2.. run function hss:recipes/crunching_table/granite
execute if score @s[nbt={Item:{id:"minecraft:gravel"}}] count matches 2.. if score @e[type=item,distance=...3,nbt={Item:{id:"minecraft:cobblestone"}},sort=nearest,limit=1] count matches 2.. run function hss:recipes/crunching_table/andesite
...
execute if score @s[nbt={Item:{id:"minecraft:crafting_table"}}] count matches 1.. if score @e[type=item,distance=...3,nbt={Item:{id:"minecraft:smithing_table"}},sort=nearest,limit=1] count matches 1.. if score @e[type=item,distance=...3,nbt={Item:{id:"minecraft:anvil"}},sort=nearest,limit=1] count matches 1.. run function hss:recipes/crunching_table/advanced_workbench
execute if score @s[nbt={Item:{id:"minecraft:shulker_shell"}}] count matches 2.. if score @e[type=item,distance=...3,nbt={Item:{id:"minecraft:chest"}},sort=nearest,limit=1] count matches 1.. run function hss:recipes/crunching_table/portable_box
