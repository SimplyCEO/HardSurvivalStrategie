...
execute if entity @s[type=minecraft:player,tag=!inside_claimed_area] unless score @s gm_player matches 0 unless score @s isOP matches 1.. run gamemode survival @s
