...
execute as @e[type=minecraft:player,scores={debug=1}] run tellraw @s "[§2§lADVANCED HOPPER§f] Module§9 hss:blocks/advanced_hopper/remove §floaded."

kill @e[type=minecraft:item,nbt={Item:{id:"minecraft:hopper"}},distance=..2,sort=nearest,limit=1]
